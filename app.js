const APP_KEY = "lifecounter_v16_9";
...
function tick() {
    ...
    if (rem <= 0) {
        ...
        if (!emergencySent && TARGET_EMAIL) {
            ...
            sendGasNotification("EMERGENCY ALERT", msg);
        }
    } else {
